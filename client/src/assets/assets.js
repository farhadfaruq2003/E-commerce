...
export const getProductImage = (productName) => {
  ...
  // Format product name to match asset naming convention
  const formattedProductName = productName.toLowerCase().replace(/ /g, "_").replace(/[^\w]/g, "");

  // Look for exact match first
  let imageKey = Object.keys(assets).find(key =>
    key.toLowerCase() === formattedProductName
  );

  // If no exact match, try partial match
  if (!imageKey) {
    imageKey = Object.keys(assets).find(key =>
      key.toLowerCase().includes(formattedProductName) ||
      formattedProductName.includes(key.toLowerCase())
    );
  }

  // If still no match, try to match by individual words
  if (!imageKey) {
    const productWords = formattedProductName.split('_');
    for (const word of productWords) {
      imageKey = Object.keys(assets).find(key =>
        key.toLowerCase().includes(word) && key.endsWith('_image')
      );
      if (imageKey) break;
    }
  }

  return assets[imageKey] || null;
};
...
export const dummyProducts = [
  // Vegetables
  {
    ...
    price: 25,
    offerPrice: 20,
    image: ["https://images.unsplash.com/photo-1603161660785-70c4c1c0f04f?w=300"],
    description: [
      "Fresh and organic",
  ...
  },
  {
    ...
    price: 40,
    offerPrice: 35,
    image: ["https://images.unsplash.com/photo-1594470898140-16b7b43210f0?w=300"],
    description: [
      "Juicy and ripe",
      "Rich in Vitamin C",
  ...
  },
  {
    ...
    price: 30,
    offerPrice: 28,
    image: ["https://images.unsplash.com/photo-1542818212-9899bafcb9db?w=300"],
    description: [
      "Sweet and crunchy",
      "Good for eyesight",
  ...
  },
  {
    ...
    price: 18,
    offerPrice: 15,
    image: ["https://images.unsplash.com/photo-1596772227804-ee6d2e4f3e0e?w=300"],
    description: [
      "Rich in iron",
      "High in vitamins",
  ...
  },
  {
    ...
    price: 22,
    offerPrice: 19,
    image: ["https://images.unsplash.com/photo-1581044799570-77f3bdd97356?w=300"],
    description: [
      "Fresh and pungent",
      "Perfect for cooking",
      "A kitchen staple",
  ...
  // Fruits
  {
    ...
    price: 120,
    offerPrice: 110,
    image: ["https://images.unsplash.com/photo-1570913149827-d2ac885b6b0f?w=300"],
    description: [
      "Crisp and juicy",
      "Rich in fiber",
      "Boosts immunity",
  ...
  },
  {
    ...
    price: 80,
    offerPrice: 75,
    image: ["https://images.unsplash.com/photo-1548369735-6e9f1c5fdc68?w=300"],
    description: [
      "Juicy and sweet",
      "Rich in Vitamin C",
  ...
  // Dairy
  {
    ...
    price: 60,
    offerPrice: 55,
    image: ["https://images.unsplash.com/photo-1602884520881-88fb9443c10d?w=300"],
    description: [
      "Pure and fresh",
      "Rich in calcium",
  ...
  },
  {
    ...
    price: 90,
    offerPrice: 85,
    image: ["https://images.unsplash.com/photo-1594041680534-e8c8c6c96397?w=300"],
    description: [
      "Farm fresh",
      "Rich in protein",
  ...
  },
  {
    ...
    price: 76,
    offerPrice: 71,
    image: ["https://images.unsplash.com/photo-1518976712520-0a2c37ba1c1f?w=300"],
    description: [
  ...
  // Grains
  {
    ...
    price: 550,
    offerPrice: 520,
    image: ["https://images.unsplash.com/photo-1516450360442-8ac9f7d83a98?w=300"],
    description: [
  ...
  // Bakery
  {
    ...
    price: 40,
    offerPrice: 35,
    image: ["https://images.unsplash.com/photo-1505427585681-6b707080e4a7?w=300"],
    description: [
      "Soft and healthy",
